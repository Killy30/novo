...
class Add{
    async searchUser(){
        ...
        //filtrar el arreglo users para que me devuelve solo los usuarios student
        let _users = users.users.filter(element =>{
            return element.category === 'student'
        })
        ...
        for(let user of _users){
            ...
            if(name.indexOf(text) !== -1 || lasName.indexOf(text) !== -1){
                showResult.innerHTML += `
                    <a href="/profile/student/${user._id}" class="box_user_search">
